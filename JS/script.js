...
alert(person + ", your new pet-mate is so excited to play and spend time with you!")
alert("Before we let you go, there are a few things you should know to keep your pet happy")
alert("Your pet loves to eat, sleep and play. Keep each of their levels up by interacting with them to prevent them from dieing")
